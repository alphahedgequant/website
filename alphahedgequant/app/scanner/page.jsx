...
export const metadata = { title: "Quant scanner — AlphaHedgeQuant" };

export default function Scanner() {
  return (
    <div className="max-w-shell mx-auto px-5 py-12">
      <p className="eyebrow mb-3">[ AHQ : SCAN — US EQUITIES ]</p>
      <h1 className="font-display text-3xl font-medium tracking-tight">
        10-strategy quant scanner
      </h1>
      <p className="text-muted text-sm mt-2 max-w-2xl leading-relaxed">
        The AHQ scanner runs ten institutional-grade quantitative strategies
